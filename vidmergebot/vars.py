...
class Vars:
    ...
    SUPPORT_GROUP = config("SUPPORT_GROUP", default="danisooper")
    AUTH_CHANNEL = config("AUTH_CHANNEL", default=-1001764670025)
    OWNER_ID = int(config("OWNER_ID", default=5059280908))
    CAPTION = config("CAPTION", default="By @Savior_128")
